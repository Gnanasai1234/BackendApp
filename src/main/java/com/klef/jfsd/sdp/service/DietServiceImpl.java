...
public class DietServiceImpl implements DietService {
    ...
    @Override
    public List<UserDietRetrival> getuserdiet(int id,LocalDate date) {
    	System.out.println(id);
    	System.out.println(date);
        List<Diet> userdiet = dietrepository.findAllByUidAndDate(id,date);
        List<UserDietRetrival> userDietList = new ArrayList<>();
//        System.out.println(userdiet.getFirst());
